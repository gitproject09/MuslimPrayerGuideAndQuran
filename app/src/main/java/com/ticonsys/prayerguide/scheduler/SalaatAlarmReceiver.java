...
import com.ticonsys.prayerguide.RingAlarmActivity;
...
public class SalaatAlarmReceiver extends WakefulBroadcastReceiver implements Constants {
  ...
  private String getPrayerKeyFromIndex(AppSettings settings, int prayerIndex, int index) {
    ...
    switch (prayerIndex) {
      ...
      case 5:
        key = settings.getKeyFor(AppSettings.Key.IS_SEHRI_ALARM_SET, index);
        break;
      case 6:
        key = settings.getKeyFor(AppSettings.Key.IS_IFTAR_ALARM_SET, index);
        break;
    }
    return key;
  }
  ...
  private String getPrayerNameFromIndex(Context context, int prayerIndex) {
    ...
    switch (prayerIndex) {
      ...
      case 5:
        prayerName = context.getString(R.string.sehri);
        break;
      case 6:
        prayerName = context.getString(R.string.iftar);
        break;
    }
    return prayerName;
  }
